...
Page({
    ...
    onLoad: function(option) {
        ...
        var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&appid=' + app.globalData.appid;
        that.loadList(url);
        // 获取硬件信息
        wx.getSystemInfo({
    ...
    pullUpLoad() {
        ...
        if (that.data.currentTab == 0) {
            ...
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=0' + '&appid=' + app.globalData.appid;;
            that.loadList(url);
        } else if (that.data.currentTab == 2) { //复审
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=1' + '&appid=' + app.globalData.appid;;
            that.loadList(url);
        } else if (that.data.currentTab == 3) {
            console.log('未通过')
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=2' + '&appid=' + app.globalData.appid;;
            that.loadList(url);
        } else {
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=3' + '&appid=' + app.globalData.appid;;
            that.loadList(url);
        }
    },
    // 滑动切换tab
    bindChange: function(e) {
        ...
        if (e.detail.current == 0) { //全部
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&appid=' + app.globalData.appid;
            that.loadList(url);
        } else if (e.detail.current == 1) { //初审
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=0' + '&appid=' + app.globalData.appid;
            that.loadList(url);
        } else if (e.detail.current == 2) { //复审
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=1' + '&appid=' + app.globalData.appid;
            that.loadList(url);

        } else if (e.detail.current == 3) { //未通过
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=2' + '&appid=' + app.globalData.appid;
            that.loadList(url);
        } else if (e.detail.current == 4) { //已通过
            var url = 'https://mfkapi.39yst.com/appInterface/mfkdoctor/getExpertRecordList2/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=3' + '&appid=' + app.globalData.appid;
            that.loadList(url);
        }
    },
            ...
            success: function(res) {
                ...
                if (that.data.page == 1) {
                    that.setData({
                        ...
                        mouthNum: res.data.mouthNum,
                        totalNum: res.data.totalNum,
                        num1: res.data.num1, //全部
                        num2: res.data.num2, //全部
                        num3: res.data.num3, //审核中
                        num4: res.data.num4, //未通过
                        num5: res.data.num5, //已通过
